...
export const siteConfig = {
  ...
  shortName: "PPG",
  title: "Prince Parfait GANZA — Software Engineer & AI Builder",
  description:
    "Software Engineer, AI Builder, and Founder of Lerony. Building software that creates impact across Africa and beyond.",
  tagline: "Building software that creates impact.",
  url: "https://princeparfait.dev",
  ...
  social: {
    ...
    linkedin: "https://linkedin.com/in/princeparfaitganza",
    twitter: "https://twitter.com/GanzaParfait",
    youtube: "https://youtube.com/@GanzaParfait",
    instagram: "https://instagram.com/ganzaparfait",
  },
  contact: {
    email: "hello@princeparfait.dev",
